...
def GPT_extraction_list_and_NER(sentences : list , mode:str='gpt-3.5' , filter: bool = True) -> dict:
    ...
    raw_data = []
    input_sentence = ""
    # TODO : recording percentage of sentences progress
    ...
    return {'entities' : entity_data , 'relations' : relation_list}
